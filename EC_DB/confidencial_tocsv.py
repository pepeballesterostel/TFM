...
"""
This script gets confidencial htmls and creates a csv file with information
about the 'fecha', 'municipio' and 'prediccion' in text.
Remember to run *add_provincias_to_EC* in order to add the provincias
information corresponding to the AEMET dataset.

It is necessary to have stored in a directory the target html files to be
scrapped. 
