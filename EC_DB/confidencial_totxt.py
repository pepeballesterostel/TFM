...
This Script scrapes the predictions from ElConfidencial and returns
a list contining each parragraph of interest. First of all, it is necessary
to have stored in a folder the html files of the web. In my case, this was done 
with the scrapping web tool called 'Httrack'. 
